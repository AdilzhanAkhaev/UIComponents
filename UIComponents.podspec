...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/AdilzhanAkhayev/UIComponents'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'AdilzhanAkhayev' => 'a.akhayev@aviata.me' }
  s.source           = { :git => 'https://github.com/AdilzhanAkhayev/UIComponents.git', :tag => s.version.to_s }
